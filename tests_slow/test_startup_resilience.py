...
@pytest.mark.xfail(reason="pre-M1 drift: serpapi reconcile loop REMOVED from startup (was burning 288 quota/day), task never created; test obsolete", strict=False)
@pytest.mark.asyncio
