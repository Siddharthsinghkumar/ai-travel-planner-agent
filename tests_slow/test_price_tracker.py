...
async def test_check_held_booking_prices_fallback_accepts_search_flights_tuple(monkeypatch):
    ...
    monkeypatch.setattr("tools.price_tracker_tool_gateway.search_with_booking_token", fake_search_with_booking_token)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.search_flights", fake_search_flights)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.get_active_held_bookings", fake_get_active_held_bookings)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.build_booking_handoff_url", fake_build_booking_handoff_url)
...
async def test_check_held_booking_prices_expires_legacy_rows_missing_route_fields(monkeypatch):
    ...
    monkeypatch.setattr("tools.price_tracker_tool_gateway.search_with_booking_token", should_not_run_search_with_booking_token)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.search_flights", should_not_run_search_flights)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.get_active_held_bookings", fake_get_active_held_bookings)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.expire_held_booking_for_tracking_invalid_data", fake_expire_held_booking_for_tracking_invalid_data)
    monkeypatch.setattr("tools.price_tracker_tool_gateway.build_booking_handoff_url", fake_build_booking_handoff_url)
...
def test_cleanup_invalid_held_tracking_rows_expires_startup_legacy_rows(monkeypatch):
    ...
    monkeypatch.setattr("tools.price_tracker_tool_gateway.get_active_held_bookings", fake_get_active_held_bookings)
    monkeypatch.setattr(
        "tools.price_tracker_tool_gateway.expire_held_booking_for_tracking_invalid_data",
